...
# to work with the gcc version 8.1.0. You need binutils 2.28 for gcc 8.1.0.
...
### change "LDFLAGS = @LDFLAGS@" to "LDFLAGS := -s" in src/gcc-8.1.0/libstdc++-v3/Makefile.in
...
MINGW="mingw-w64-v5.x-ed044404a7c419b9279bf4de4a7bf259566abc0f"
...
if [ ! -e "${PREFIX}/bin/liblto_plugin-0.dll" ]; then
	cp "${PREFIX}/libexec/gcc/x86_64-w64-mingw32/${GCC#gcc-}/liblto_plugin-0.dll" "${PREFIX}/bin/"
fi
if [ -e "${PREFIX}/libexec/gcc/x86_64-w64-mingw32/${GCC#gcc-}/liblto_plugin-0.dll" ]; then
	mkdir -p "${PREFIX}/mingw/lib/bfd-plugins"
	cp "${PREFIX}/libexec/gcc/x86_64-w64-mingw32/${GCC#gcc-}/liblto_plugin-0.dll" "${PREFIX}/mingw/lib/bfd-plugins"
	mkdir -p "${PREFIX}/x86_64-w64-mingw32/lib/bfd-plugins"
	cp "${PREFIX}/libexec/gcc/x86_64-w64-mingw32/${GCC#gcc-}/liblto_plugin-0.dll" "${PREFIX}/x86_64-w64-mingw32/lib/bfd-plugins"
fi
